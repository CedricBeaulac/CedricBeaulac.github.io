...
venue: "Symposium en apprentissage statistique pour les données complexes"
date: 2025-11-25
location: "Université Laval, Québec, Québec, Canada"
---

This talk was given at Université Laval as part of the [Symposium en apprentissage statistique pour les données complexes](https://www.fsa.ulaval.ca/evenements/symposium-apprentissage-statistique/), an event to officially launch a reasearch chair un statistical learning. 
...
Slides are available [here](https://cedricbeaulac.github.io/files/Symposium2025_ShapeAnalysis.pdf).
